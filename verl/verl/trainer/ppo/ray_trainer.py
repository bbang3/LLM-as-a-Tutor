...
class RayPPOTrainer:
    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            # Align validation with training: if RM workers are enabled, precompute rm_scores.
            need_rm_scores = self.use_rm

            print("assigning rm scores start")
            if need_rm_scores and "rm_scores" not in test_batch.batch.keys():
